...
let startBtn = document.getElementById("start"),
    ...
    expensesBtn.style.backgroundImage ='linear-gradient(336deg,#b9b2ab,#fff8f8),linear-gradient(#fff,#fff)';
    optionalExpensesBtn.style.backgroundImage ='linear-gradient(336deg,#b9b2ab,#fff8f8),linear-gradient(#fff,#fff)';
    countBtn.style.backgroundImage ='linear-gradient(336deg,#b9b2ab,#fff8f8),linear-gradient(#fff,#fff)';
